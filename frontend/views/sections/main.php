                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10 col-lg-10">
                        ...
                        <div class="category-img text-center">
                            <a href="listing.html"> <img src="/listco/img/gallery/hero_category1.png" alt=""></a>
                            <a href="listing.html"> <img src="/listco/img/gallery/hero_category2.png" alt=""></a>
                            <a href="listing.html"> <img src="/listco/img/gallery/hero_category3.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="single-location mb-30">
                        <div class="location-img">
                            <img src="/listco/img/gallery/location1.png" alt="">
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="single-location mb-30">
                        <div class="location-img">
                            <img src="/listco/img/gallery/location2.png" alt="">
                        </div>
                        <div class="location-details">
                            <p>Paris</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-location mb-30">
                        <div class="location-img">
                            <img src="/listco/img/gallery/location3.png" alt="">
                        </div>
                        <div class="location-details">
                            <p>Rome</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-location mb-30">
                        <div class="location-img">
                            <img src="/listco/img/gallery/location4.png" alt="">
                        </div>
                        <div class="location-details">
                            <p>Italy</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-location mb-30">
                        <div class="location-img">
                            <img src="/listco/img/gallery/location5.png" alt="">
                        </div>
                        <div class="location-details">
                            <p>Nepal</p>
        ...
        <div class="container">
            ...
            <div class="directory-active">
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="/listco/img/gallery/properties1.png" alt=""></a>
                            <div class="img-text">
                                <span>$$$</span>
                                <span>Closed</span>
                            </div>
                            <div class="icon">
                                <img src="/listco/img/gallery/categori_icon1.png" alt="">
                            </div>
                        </div>
                        ...
                        <div class="properties__footer d-flex justify-content-between align-items-center">
                            <div class="restaurant-name">
                                <img src="/listco/img/gallery/restaurant-icon.png" alt="">
                                <h3>Food & Restaurant</h3>
                            </div>
                            <div class="heart">
                                <img src="/listco/img/gallery/heart1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="/listco/img/gallery/properties2.png" alt=""></a>
                            <div class="img-text">
                                <span>$$$</span>
                                <span>Closed</span>
                            </div>
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="/listco/img/gallery/properties3.png" alt=""></a>
                            <div class="img-text">
                                <span>$$$</span>
                                <span>Closed</span>
                            </div>
        ...
        <div class="container">
            ...
            <div class="directory-active">
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="/listco/img/gallery/newDirectory1.png" alt=""></a>
                            <div class="img-text">
                                <span>$$$</span>
                                <span>Closed</span>
                            </div>
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="/listco/img/gallery/newDirectory2.png" alt=""></a>
                            <div class="img-text">
                                <span>$$$</span>
                                <span>Closed</span>
                            </div>
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="/listco/img/gallery/newDirectory3.png" alt=""></a>
                            <div class="img-text">
                                <span>$$$</span>
                                <span>Closed</span>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="single-location mb-30">
                        <div class="location-img">
                            <img src="/listco/img/gallery/home-blog1.png" alt="">
                        </div>
                        <div class="location-details">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="single-location mb-30">
                        <div class="location-img">
                            <img src="/listco/img/gallery/home-blog2.png" alt="">
                        </div>
                        <div class="location-details">
                            <a href="#" class="location-btn">Tips</a>
                            <ul>
            ...
            <div class="wants-wrapper w-padding2">
                <div class="row justify-content-between">
                    <div class="col-xl-8 col-lg-8 col-md-7">
                        <div class="wantToWork-caption wantToWork-caption2">
                            <img src="/listco/img/logo/logo2_footer.png" alt="" class="mb-20">
